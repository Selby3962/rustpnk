...
<Tabs client:load>
    ...
    #### Scene
    Spotless roads snake through rolling green hills, each bend revealing opulent mansions of glass and marble, each one a bespoke work of art, perched like temples above the sea. A sea breeze carries the scent of salt and ozone over the wrought iron gates, manicured hedgerows and pristine villas. Somewhere behind layers of glass and biometric locks, laughter echoes from a private gala. 
...
<Tabs client:load>
    ...
    The Dark Zone is a dizzyingly tall, overcrowded stack of crumbling, dilapidated structures that seem to meld into one another, forming a tangled web of narrow alleys, staircases, and tunnels.
...
<Tabs client:load>
    ...
    #### Places
    ##### Vostok Enclave
    - Much of the wharf is taken up by the "Vostok Enclave", a ramshackle town of cargo containers.
...
<Tabs client:load>
    ...
    As the processing of identification and citizenship ground to a halt under the immense weight of new arrivals, many chose to settle in for the long haul, and the park became it's own, semi-independent entity.

    The people of Takhoma Park are deeply distrustful of the corporations and government entities that dominate Wuhai. They see themselves as free spirits, fiercely independent and unyielding in the face of authority.
