...
Wuhai, like many similar settings, is a city of contrasts: the sleek corporate towers of Utashino Estates versus the lawless unknown of the Yamaloka Dark Zone; the high-tech lifestyle of the wealthy elite juxtaposed with the harsh realities faced by those who eke out a living on the war-torn streets of Heng Fa.
...
<Tabs client:load>
    ...
    #### Landmarks
    ##### The ShinWa Station
    - At the heart of the district stands the immense cooling towers of the Shinwa Station. It's output responsible for the majority of Wuhai's power supply.
    ...
    | 5_ON_D8 | A scream emanates from a nearby burning slag heap, a severely burnt figure crawls out from within.                                                                                                                                     |
    ...
    | 7_ON_D8 | A freight truck carrying volatile fuel near a highway support pillar and begins to spill out it's contents into the street. Multiple groups of scavengers spring from the shadows in an attempt to siphon it. Fighting breaks out.     |
...
<Tabs client:load>
    ...
    #### People
    ##### Mayor Haoyu Xian
    - The official Mayor of Wuhai. A once idealistic politician. Now, a tired bureaucrat, intimately aware of the ceremonial nature of his role, but clinging to the prestige and benefits of his office.
    ...
    - It's cutting-edge medical technology is available to those with the ₩on to afford medical insurance.
    ...
    - A bar in Komorebi is the scene of the gruesome death of an ill-looking patron. In the days that follow, other members of the community fall ill with similar symptoms. Regenesis quickly quarantine the district. Rumours spread of a bio-engineered virus, unleashed somewhere in the district.
