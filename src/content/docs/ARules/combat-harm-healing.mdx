...
When facing off against an NPC, each point of **Toughness** adds one **Danger Die** to the pool. This is in addition to any conditions, gear, augs, scene tags etc. that might also add Danger Dice. (See: [Skill Checks](/rustpnk/docs/arules/skill-checks))
