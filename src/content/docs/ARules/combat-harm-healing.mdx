...
However, during [Downtime](/rustpnk/docs/arules/downtime-advancement) you can do the following:
...
- Pay for specialist help. This is a costly option. See [Spending ₩](/rustpnk/docs/arules/downtime-advancement#earning--spending).
