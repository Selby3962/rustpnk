---
title: 1 - Skill Checks & Action Points
description: ""
...
### Assisting Allies
- If one or more allies are assisting you, add 1 <AD/>. <br/> *Note that this is a one-time bonus. Multiple people helping does not add more than 1* <AD/>
...
- **Tough it Out:** Ignore the <TD/> penalty of a single Trauma until the adrenaline wears off (typically, a scene or two).
<br/><p class="text-center">*Describe how you steel yourself and push past your wounds*<br/>*The Trauma is still there, you're just ignoring it. It will return once the adrenaline wears off.*</p>
