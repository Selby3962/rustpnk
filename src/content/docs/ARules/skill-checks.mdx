---
title: 2 - Skill Checks & Action Points
description: ""
...
When a character's course of action is dangerous or uncertain, the GM will call for a **Check**. <br/>
...
|                  |                                                                                                                                                                  |
| ---------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   **Toughness:** | Add <TD/> equal to the current Toughness of the threat.<br/>*The Health of the threat. Reduced as the threat takes damage.*                                      |
...
|      **Wounds:** | Add 1 <TD/> for **each** relevant **Wound** you have at Level 2 or Higher.                                                                                       |
|      **Trauma:** | Add 1 <TD/> for **each** Trauma you have.<br/>*Added regardless of whether or not it is relevant to the current check.*                                          |
|        **Flaw:** | Add 1 <TD/> if you invoke a Flaw to impede you.<br/>*When you do, regain 1* ***Action Point.***                                                                  |
</div>
<br/>
...
### Assisting Allies
- If one or more allies are assisting you, add 1 <AD/>. <br/> *Note that this is a one-time bonus. Multiple people helping cannot add more than 1* <AD/>
- In complicated situations, the person helping may need to make their own check first. <br/>*E.g. Hacking security, causing a distraction etc.*
...
<p class="text-center">*Advantages & Consequences can be anything, follow the flow and do what makes the most sense in the fiction.*</p>
...
<br/>
#### Minor Consequences
- **Harm:** Suffer a Level 1 Wound
- **Conditions:** Suffer a Condition
...
<br/><p class="text-center">*Describe what you do to create a momentary distraction or opportunity*<br/>*The Player who spent the point decides who Acts.*</p>
- **Tough it Out:** Ignore the <TD/> penalty of a single Trauma for the rest of the job.
<br/><p class="text-center">*Describe how you steel yourself and push past your wounds*<br/>*The Trauma is still there, you're just ignoring it.*</p>
...
- You can invoke a **Flaw** to hinder yourself and gain 1 AP.
