...
When you need to know if a character breaks into the Cerberus compound, survives a beat-down, hacks a security system, or does some other cool thing, make a **check**. <br/>
You will create a pool of **Action** (⛊) and **Danger** (⛉) dice, which are normal six-sided dice (D6) in two different colours.
...
- **Enemy Toughness:** The Toughness rating of the enemy you're facing. Higher if an enemy is bigger, tougher, more skilled, or especially powerful.
...
##### Seize Momentum
- Spend a Stunt Point to take control away from the enemies during Combat. See [Momentum](/docs/arules/combat-harm-healing#momentum)
