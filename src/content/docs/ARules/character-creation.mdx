...
## Choose or Create Three "Trademarks"

Who were you before, who are you now, how have you survived?

- "Trademarks" are broad tags that describe the most important, interesting, or useful details about your character.
- These are usually a combination of a Background, an Archetype, and Advantages.
- Using a trademark grants you an additional die when making [Skill Checks](/docs/arules/skill-checks).
...
## Pick four "Triggers" to become "Edges"
...
Edges grant additional dice when making [Skill Checks](/docs/arules/skill-checks) using their associated Trademark.

---

## Write Two "Flaws"

Pick or create **two Flaws**. Flaws are troubles, problems, vices, or disadvantages that your character must deal with.
These should ideally be related to your Trademarks.

Dealing with a Flaw in-play refreshes your [Stunt Points](/docs/arules/skill-checks), which are used to improve your chances of success during a job.
...
For more information, see: [Gear System](/docs/arules/gear)
...
<Tabs client:load>
    ...
    <Tab name="Weapons / Armour">
        ...
        |         Item          | Feature                                                                                                                                                                                      | Basic Tags                                                                               | Gear Slots |
        | :-------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------- | :--------: |
        | Security Grade Armour | - Sets your Armour Track Max to 3.<br/>- After soaking 3 hits, the armour is ruined.                                                                                                         | ⛊ Armoured                                                                              |     ◆      |
        |      Short Blade      | - Deals 1 hit on successful check.<br/>- Deals 1 hit on successful check.<br/>- On a 6: Grants target the "Bleeding" condition for 1d3 turns.<br/>- Guaranteed if target is unaware.         | Attack<br/>⛊ Quiet<br/>Bloody<br/>⛉ Short Range                                        |     ◆      |
        |      Long Blade       | - Deals 1 hits on successful check.<br/>- Grants 1 Action Die for defence in melee combat.<br/>- On a 6: Grants target the "Bleeding" condition for 1d3 turns.                               | Attack<br/>⛊ Parry<br/>Bloody                                                           |     ◇      |
        |      Short Blunt      | - Deals 1 hit on successful check.<br/>- On a 6: Grants target the "Stunned" condition for 1d3 turns.<br/>- Guaranteed if target is unaware.                                                 | Attack<br/>⛉ Short Range                                                                |     ◆◆     |
        |      Long Blunt       | - Deals 1 hits on successful check.<br/>-Grants 1 Action Die for defence in melee combat.<br/>- On a 6: Grants target the "Stunned" condition for 1d3 turns.                                 | Attack<br/>⛊ Block<br/>                                                                 |     ◆◆     |
        |     Light Sidearm     | - Deals 2 hits on successful check.<br/>- No penalty at close range.                                                                                                                         | Shoot <br/>⛉ Low-Penetration <br/>⛉ Loud                                               |     ◆      |
        |     Heavy Sidearm     | - Deals 2 hits on successful check.<br/>- No penalty at close range.<br/>- Grants 1 Action Die against Armoured targets.                                                                     | Shoot <br/>⛊ High-Penetration<br/>⛉ Loud                                               |     ◆      |
        |         Rifle         | - Deals 2 hits on successful check.<br/>- +1 Danger Die when used at close-range<br/>- Grants 1 Action Die against Armoured targets.<br/>- Ignores "Armoured" tag on enemies (-1 Danger Die) | Shoot <br/>⛊ High-Penetration <br/>⛊ Long-Range<br/>⛉ Loud<br/>⛉ Close Range Penalty |     ◇      |
        |        Shotgun        | - Deals 2 hits on successful check.<br/>- After a hit: Roll 1d6 for each additional nearby target (friend or foe).<br/>- 6: Target takes 1 hit.<br/>- 4-5: Target gains a condition.         | Shoot <br/> Spread<br/>⛉ Loud                                                           |     ◆◆     |
        <br/>
...
- You can purchase, install and swap out Augs during [Downtime](/docs/arules/downtime-advancement). **Your choices now don't have to be permanent, just go with what seems cool.**
<br/>
...
- You may pick a particular, *signature Aug* as a "Trademark", and add tags related to it as *"Edges"* under it. An Aug added this way does not count toward your Augmentation Limit.

#### Un-Augmented Characters
For characters who prefer to remain pure and untainted by Augmentation, ask the GM about upgrading two of your Items with **Advanced Tags**. You saved money on maintenance, but keeping up with the augmented competition still wasn't cheap.

---

## Benefit of Experience
Individualise your character further by choosing one of the following [Advancement](/docs/arules/downtime-advancement) bonuses to start out with:
...
All players start with **2d6x100** **₩**.
...
|     |                                              |     |                                                          |
| --: | :------------------------------------------- | --: | :------------------------------------------------------- |
|   1 | A family member or friend has a problem      |  11 | You want to realize a dream                              |
|   2 | You botched your last responsibility         |  12 | You want to kill or depose your boss                     |
|   3 | You're being blackmailed or coerced          |  13 | You want to indulge in rare and/or expensive pleasures   |
|   4 | You're being pursued by a dire nemesis       |  14 | You want to leave your current life                      |
|   5 | You're struggling with mental trauma         |  15 | You want to obtain a particular item                     |
|   6 | You've earned a dangerous foe                |  16 | You want to prove yourself to others                     |
|   7 | You've gotten addicted to something          |  17 | You want to rescue someone from trouble                  |
|   8 | You've lost or had a vital thing stolen.     |  18 | You want to take revenge on a foe, (at any cost?)        |
|   9 | You made promises you can’t keep             |  19 | You want to explore your mysterious past                 |
|  10 | You want respect and admiration from someone |  20 | You want to pursue justice for yourself, or someone else |
<br/>
