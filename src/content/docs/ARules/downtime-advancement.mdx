...
## Aftermath Phase
Immediately after a Job is the Aftermath Phase. This is when rewards from Jobs are paid out, and **Heat** & **Reputation** are tallied up.

See [Crew Mechanics](/docs/arules/crew-faction) for more detail about the stages of this phase.
...
**Heat** is displayed as a Track, split into groups of three, every **three ticks** your Retribution Rating increases. 
...
**When Rep passes certain Thresholds, the Crew's Reputation Level increases:**
<div class="table-full">
| 0 Rep   | 10 Rep   | 20 Rep | 40 Rep    | 60 Rep    | 80 Rep  |
| ------- | -------- | ------ | --------- | --------- | ------- |
| Unknown | Whispers | Known  | Respected | Connected | Legends |
</div>
...
**Opposition/Employer/Tier** - **Typical Payout**
- **Street Gang / Tier I:** ₩500 - ₩1,500
- **Organised Gang / Tier II:** ₩1,500 - ₩3,500
- **Major Syndicate / Tier III:** ₩3,500 - ₩10,000
- **Corporation / Tier IV+:** ₩10,000 - ₩25,000
...
Additional loot such as data and loose items can usually be sold to a fence for a marked-down fee. Player contacts or other special efforts to locate the *right* buyer can up the amount gained.

---

## Downtime Phase
The period between Jobs is called Downtime. During this time, characters can train, attempt to [heal injuries](/docs/arules/combat-harm-healing#recovery), purchase [gear](/docs/arules/gear), work on projects, etc.
...
<br/>These can occur whenever it makes narrative sense, and will be increasingly dangerous the more enemies, heat, and wanted levels the crew have.
...
**Add Danger Die for:**
- **Retribution:** Every Three Heat the Crew have increases their Retribution Rating. **Add Danger Die equal to their Retribution Rating.**
