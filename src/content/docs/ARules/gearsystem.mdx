...
title: 5 - Gear System
description: ""
image: "@assets/docs/headers/dealer.png"
#hideToc: true
#hideNav: true
---

<div class="w-full" style="text-align:center"> <h2> [-Full Gear List\-](/docs/etables/gear) </h2> </div>
...
- Your maximum Augmentation Slots can be increased with [Advancements](/docs/arules/downtime-advancement).

You can purchase, install and swap out Augmentations during [Downtime](/docs/arules/downtime-advancement).
