...
- For example: You can case the joint while Subtle, then return and gear up to Obvious for the heist.
...
<p class="text-center">**The Project Clock has a number of segments equal to:**<br/> 8 - Engineering or Tech Skill (whichever is most relevant)</p>

<p class="text-center">**For example, a character with +2 Engineering works on a Drone.** <br/> The Project Clock has 8 Segments - 2 for Engineering Skill.</p><p class="text-center"> **Total Segments:** 6.</p>
<div class="clock w-full text-center"> 0/8 > 0/6 </div>

**Regardless of how good you are at crafting, there will more than likely be additional complications and overheads to consider:**
<div class="sonohead">
|                     |                                                                                                                                                                                              |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Base Difficulty** | All Crafting Project checks have a base number of <TD/> equal to 1 + the number of Gear Slots they take up.                                                                                  |
| **Expertise**       | Without the right knowledge, tools, schematics, or access to an expert, the GM may decide to add +1 - +3<TD/> to the check to progress the Project, depending on the complexity of the item. |
| **₩ for Materials** | You can't make something from nothing. You may need to pay for materials (100% of the base item/mod cost - 20% for each level in Engineering/Tech).                                          |
...
**Vehicles:**
- You can Mod a Vehicle, but you cannot craft one from scratch.
