...
|      Boathouse       | **Requires Canal Access.** <br/> Safe storage for 2 water vehicles.<br/> +1<AD/> to modify and repair water Vehicles. <br/> Can attempt to add a 3rd "Advanced Tag" to water Vehicles. <br/>Roll using any relevant crafting skills.<br/> Add +3 <TD/> as a base. | ₩4,000 |
|    Hangar/Helipad    | A secure place to store 1 Aerial Vehicle.<br/> +1<AD/> to modify and repair Aerial Vehicles.<br/>Can attempt to add a 3rd "Advanced Tag" to Aerial Vehicles. <br/>Roll using any relevant crafting skills.<br/> Add +3 <TD/> as a base.                           | ₩5,000 |
|  Garage / Boathouse  | Safe storage for 2 ground vehicles.<br/> +1<AD/> to modify and repair ground Vehicles. <br/> Can attempt to add a 3rd "Advanced Tag" to ground Vehicles. <br/>Roll using any relevant crafting skills.<br/> Add +3 <TD/> as a base.                               | ₩5,000 |
...
|       Workshop       | +1<AD/> to Engineering checks made here. <br/>Can attempt to add a 3rd "Advanced Tag" to Gear, Weapons, and Armour. <br/>Roll using any relevant crafting skills.<br/> Add +2 <TD/> as a base, and +1 <TD/> for every Gear Slot the item takes up.                | ₩8,000 |
