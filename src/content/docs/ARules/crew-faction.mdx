...
**Heat** is displayed as a Track, split into groups of three, every **three ticks** your Retribution Rating increases. As your Retribution increases, the events and complications you'll face during downtime become more severe. See [Downtime](/docs/arules/downtime-advancement#events--retribution).
...
See [Factions](/docs/cfactions/) for a full list.