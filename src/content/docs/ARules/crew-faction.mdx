...
<p class="text-center">**The following rules add depth and a system of shared progression for the PCs. This sub-system is great for longer campaigns, but is largely irrelevant for shorter games and one-shots.**
<br/><br/>**Introduce these steps after Character Creation, or after the first job.**</p>
...
If its a little vague, or the characters don't really know each other yet, either write a broad descriptor of what the group currently is (Drifters, Freelancers, Nobodies, etc.), or just skip this. Do a few more jobs and come back to it.
...
<p class="text-center">The Crew Sheet displays twelve, 8-Segment [Clocks](/rustpnk/docs/arules/skill-checks#clocks--extended-checks). <br/>Every point of Status adds one tick to a clock.</p>

<div class="clock w-full text-center"> 8/8 8/8 8/8 8/8 3/8 0/8 0/8 0/8 0/8 0/8 0/8 0/8 </div>
...
<p>
- **GM Advice:** For shorter, faster campaigns, half the number of clocks required for each tier.
</p>
...
- This could represent a public embarassment or betrayal that damages your reputation.
...
|              Club/Bar               | Hot Spot: (See List Below)                      | ₩15,000 | 3                |
...
<p>
- Property comes with some inherent features. *Re-style these as desired.* <br/>These don't count toward the Property's Max Improvements.
...
| :---------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------ |
|   Alarm System    | Early warning system. You will be alerted to any visitors or hostilties in advance.                                                                                                                                                                     | ₩1,000 |
|     Safe Room     | Secure storage, heavily armoured, and supplies to survive for up to a week.<br/> A safe place to store valuables, or shelter if under attack.                                                                                                           | ₩1,000 |
...
|     Amenities     | +1<AD/> to checks related to recovery of health or stress.                                                                                                                                                                                              | ₩2,000 |
|        Lab        | +1<AD/> to research and chemistry-related checks and long-term projects.                                                                                                                                                                                | ₩4,000 |
|    Server Room    | +1<AD/> to coding, hacking, and development related checks and long-term projects.                                                                                                                                                                      | ₩4,000 |
|      Medbay       | +1<AD/> to checks related to recovery of health or stress. <br/>+1<AD/> to checks related to surgery.                                                                                                                                                   | ₩4,000 |
...
|  Hangar/Helipad   | A secure place to store 1 Aerial Vehicle.<br/> +1<AD/> to modify and repair Aerial Vehicles.                                                                                                                                                            | ₩5,000 |
|      Garage       | Safe storage for 2 ground vehicles.<br/> +1<AD/> to modify and repair ground Vehicles.                                                                                                                                                                  | ₩5,000 |
...
|     Workshop      | Can attempt to add a 3rd "Advanced Tag" to gear. <br/>Roll using any relevant crafting skills.<br/> Add +2 Threat Die as a base, and +1 Threat Die for every Gear Slot the item takes up.<br/>In addition, add +1<AD/> to Engineering checks done here. | ₩8,000 |
